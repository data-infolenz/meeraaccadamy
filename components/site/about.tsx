          ...
          <div className="lg:col-span-7">
            <ul className="grid gap-4 sm:grid-cols-2">
              {highlights.map(({ icon: Icon, title, desc }, index) => (
                ...
                >
                  <TiltCard max={7} className="group h-full rounded-lg border border-white/60 bg-white/80 p-5 shadow-soft backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-accent/30 hover:shadow-card">
